/**
 * Remotion-compatible override for EndingContact slide.
 * Uses staticFile() instead of import.meta.env.BASE_URL for QR code image.
 */
      ...
      <div className="text-center flex flex-col items-center gap-10">
        ...
        <AnimatedText delay={900}>
          <div className="bg-white rounded-3xl p-4 md:p-6 shadow-lg shadow-accent-cyan/10">
            <img
              src={staticFile("pics/mpwechatqrcode.jpg")}
              alt="微信公众号二维码"
