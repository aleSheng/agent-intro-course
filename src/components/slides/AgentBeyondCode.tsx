  ...
  return (
    <div className="slide module-4 bg-[#0a0a0b] px-20">
          ...
          <AnimatedText key={i} delay={500 + i * 200} className="flex-1">
            <div className="flex flex-col items-center">
              ...
              {i < killChain.length - 1 && (
                <div className="absolute right-0 top-6 text-[#27272a]">→</div>
              )}
            </div>
          </AnimatedText>
        ))}
      ...
      <AnimatedText delay={2100}>
        <div className="mt-6 bg-accent-red/5 border border-accent-red/20 rounded-xl px-8 py-4 w-full">
          <p className="text-xl text-[#f5f5f5] text-center">
