    ...
    <div className="slide module-ending bg-[#0a0a0b] flex items-center justify-center">
      <div className="text-center max-w-[1400px]">
        <AnimatedText delay={300}>
          <p className="text-xl md:text-2xl lg:text-4xl text-[#a1a1aa] leading-relaxed mb-8">
            一个判断——
          </p>
        </AnimatedText>
        ...
        <AnimatedText delay={1600}>
          <p className="text-2xl md:text-4xl lg:text-5xl font-bold text-[#f5f5f5] leading-relaxed mt-4">
